...
export default function SeoHead({
  ...
  const canonicalUrl = `https://fgs.edu.kz${seo.path}`;
  const imageUrl = customImage || 'https://fgs.edu.kz/og-image.png';
  ...
  return (
    <Helmet>
      ...
      <link rel="alternate" hrefLang="kk" href={`https://fgs.edu.kz${seo.path}?lang=kz`} />
      <link rel="alternate" hrefLang="ru" href={`https://fgs.edu.kz${seo.path}?lang=ru`} />
      ...
      <meta name="google-site-verification" content="4X-FA6oAAzQM8o30wvYp4LXhvnXDEPUsUY-FIP5I18g" />
