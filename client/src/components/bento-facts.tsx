...
const bentoItems = [
  {
    ...
    className: "md:col-span-2 md:row-span-2 bg-blue-50 border border-blue-500/20",
    image: schoolLife,
    badge: "Кампус"
  },
  {
    ...
    className: "md:col-span-1 md:row-span-1 bg-indigo-50 border border-indigo-500/20",
    badge: "Команда"
  },
  {
    ...
    className: "md:col-span-1 md:row-span-1 bg-white border border-slate-600/30",
    badge: "Тарих"
  },
  {
    ...
    className: "md:col-span-2 md:row-span-1 bg-purple-50 border border-purple-500/20",
    badge: "UPay"
  },
  {
    ...
    className: "md:col-span-2 md:row-span-1 bg-amber-50 border border-amber-500/20",
    image: nisSuccess,
    badge: "Дайындық"
  },
  {
    ...
    className: "md:col-span-2 md:row-span-1 bg-green-50 border border-green-500/20 flex-row items-center",
    badge: "08:00 - 18:00"
  },
];
...
export default function BentoFacts() {
  return (
    <section className="py-10 bg-white" id="facts">
