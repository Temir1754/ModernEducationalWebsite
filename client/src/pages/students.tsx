...
function EventSection({
  ...
  return (
    <section className="mb-16 last:mb-0">
      {/* Banner */}
      <div className="relative mb-10 overflow-hidden rounded-2xl bg-[#0B2A5B] shadow-lg">
        {bannerImageOnly ? (
          ...
          <div className="relative flex min-h-[240px] items-center sm:min-h-[300px]">
            <PhotoSlot slots={bannerSlots} index={0} inputId={`${idBase}-banner`} hideControls className="!absolute inset-0 !bg-[#123E7C]" />
            <div className="pointer-events-none absolute inset-0 bg-gradient-to-r from-[#0B2A5B] via-[#0B2A5B]/85 to-[#0B2A5B]/10 sm:via-[#0B2A5B]/70 sm:to-transparent md:from-[#0B2A5B] md:from-30% md:via-[#0B2A5B]/60 md:via-50% md:to-transparent md:to-70%" />
            ...
            <div className="relative z-10 flex items-center gap-5 p-6 sm:p-10">
              {iconStyle === "ring" ? (
                ...
                <Icon className="hidden h-20 w-20 shrink-0 text-[#FFC83D] sm:block" strokeWidth={1.5} />
              )}
              <div>
                {eyebrow && (
                  <EditableText
                ...
                <h2 className="text-3xl font-extrabold leading-tight sm:text-5xl">
                  ...
                  <EditableText contentKey={`${prefix}.title2`} defaultValue={title2} tag="span" className="block text-[#FFC83D]" />
                </h2>
                <EditableText
        ...
        {user && (
          <div className="absolute right-3 top-3 z-20 flex flex-wrap justify-end gap-2">
            <button
              type="button"
              className="inline-flex items-center gap-1.5 rounded-full bg-white px-3 py-1.5 text-xs font-semibold text-[#0B2A5B] shadow-md hover:bg-gray-100"
            ...
            <Label
              ...
              className="inline-flex cursor-pointer items-center gap-1.5 rounded-full bg-white px-3 py-1.5 text-xs font-semibold text-[#0B2A5B] shadow-md hover:bg-gray-100"
            >
      ...
      <div className={`grid grid-cols-1 gap-8 lg:grid-cols-[1.4fr_1fr] lg:items-start mb-10`}>
        ...
        <div className="flex items-start gap-5 rounded-2xl bg-[#EAF2FC] p-6 dark:bg-[#131f35] sm:p-8">
          <Target className="h-14 w-14 shrink-0 text-[#123E7C] dark:text-blue-300" />
          <div className="border-l-2 border-[#F2A63B] pl-5">
            <EditableText
              contentKey={`${prefix}.goal.title`}
              defaultValue={goalTitle}
              tag="h3"
              className="mb-2 text-xl font-bold text-[#0B2A5B] dark:text-blue-100"
            />
            <EditableText
              ...
              tag="p"
              multiline
              className="text-[#123E7C] dark:text-blue-200"
            />
          </div>
        </div>
      </div>
          ...
          <EventSection
            ...
            bannerExtra={
              <div className="pointer-events-none absolute bottom-6 right-8 z-10 hidden max-w-[200px] -rotate-6 md:block">
                ...
                />
                <div className="ml-auto mt-1 h-1 w-32 rounded-full bg-[#FFC83D]" />
              </div>
            }
          />
              ...
              <div className="pointer-events-none absolute bottom-4 right-4 z-10 hidden gap-3 md:flex">
                <div className="pointer-events-auto flex items-center gap-2 rounded-xl bg-white/95 px-3 py-2 shadow-md">
                  ...
                  <div className="leading-tight">
                    <EditableText contentKey="students.game.legend.cow" defaultValue="– сиыр" tag="p" className="text-sm font-bold text-[#0B2A5B]" />
                    <EditableText contentKey="students.game.legend.cowHint" defaultValue="(дұрыс сан, қате орын)" tag="p" className="text-xs text-[#123E7C]" />
                  </div>
                </div>
                <div className="pointer-events-auto flex items-center gap-2 rounded-xl bg-white/95 px-3 py-2 shadow-md">
                  <span className="h-5 w-5 shrink-0 rounded-full bg-red-500" />
                  <div className="leading-tight">
                    <EditableText contentKey="students.game.legend.bull" defaultValue="– бұқа" tag="p" className="text-sm font-bold text-[#0B2A5B]" />
                    <EditableText contentKey="students.game.legend.bullHint" defaultValue="(дұрыс сан, дұрыс орын)" tag="p" className="text-xs text-[#123E7C]" />
                  </div>
                </div>
              </div>
            }
